...
<template>
  ...
  <div class="p-5">
    ...
    >
      <img v-if="UsersStore.getCurrentUserAvatarUrl()" :src="UsersStore.getCurrentUserAvatarUrl()" class="avatar" />
      <el-icon v-else>
        <Plus />
      </el-icon>
    </el-upload>
    ...
    >
      <div class="flex flex-col items-center justify-center space-y-3">
        ...
        <el-form-item prop="price" label="Password">
          <el-input :disabled="isEditing" type="password" v-model="user.password"></el-input>
        </el-form-item>
        <el-form-item
          v-if="isEditing"
          disabled
